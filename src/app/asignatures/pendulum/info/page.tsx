...
const TERMS_CONFIG: TermConfig[] = [
  {
    ...
    description:
      "Es cuando el objeto sigue una línea recta durante su movimiento, los cuerpos que tienen este tipo de movimiento se dice que tienen un movimiento rectilíneo, por ejemplo: La caída de un objeto.",
    separator: ", ",
  },
  {
    id: "acotado",
    ...
    description:
      "Con topes o límites por alguno de sus lados o todos ellos, de manera que no se puede salir de ese espacio resultante.",
    separator: ", ",
  },
  {
    id: "periodico",
    ...
    description:
      "Se denomina movimiento periódico a todo aquél que se repite a intervalos regulares de tiempo. Ej. Péndulo, rotación de la tierra en torno al Sol, movimiento de las manecillas de un reloj, etc.",
    separator: " , ",
  },
  {
    id: "variable",
    ...
    description:
      "Se refiere al acto de cambiar de posición o ubicación, y sus variables incluyen distancia, desplazamiento, velocidad, velocidad y aceleración.",
    separator: ".",
  },
];
...
const PagePendulum: React.FC = () => {
  return (
    <main className="flex flex-col items-center justify-between p-6 bg-[#f8f8f8] min-h-screen pt-16">
        ...
        <div className="w-2/3 bg-[#D9D9D9] rounded-3xl flex flex-col items-center p-6 space-y-6 md:p-8 md:space-y-8">
          ...
          <div className=" w-2/3 text-sm md:text-base leading-relaxed text-center px-2">
            <p className="mb-3 text-sm md:text-base leading-relaxed">
              En física, se llama movimiento oscilatorio mecánico a todo cambio de
              posición que posee una{" "}
          ...
          <div className="w-full flex flex-col justify-center items-center gap-6">
            <ButtonLink
              href="/asignatures/pendulum"
              text="1. Oscilaciones del péndulo armónico"
            />
            <Button text="2. Oscilaciones en el sistema masa resorte" />
          </div>
        </div>
      </div>
    </main>

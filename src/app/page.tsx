...
export default function Home() {
  return (
    <section className="w-full min-h-screen md:h-screen flex flex-col items-center justify-center text-white relative bg-[#1B1B2A] overflow-auto">
      ...
      <div className="w-full sm:w-auto order-first sm:absolute md:top-10 sm:top-8 sm:left-5 lg:top-10 lg:left-20 z-20 px-4 py-4 sm:px-0 sm:py-0">
        <p className="font-roboto font-semibold text-cyan-50 flex items-center gap-2 sm:flex-blolck">
          <Atom />
          CBTIC
        </p>
      </div>
      ...
      <div className="flex-1 w-full flex flex-col md:flex-row items-center justify-center">
        <div className="w-full h-full flex justify-center items-center md:order-2 sm:order-1 z-10 sm:w-1/2">
          <CanvasModel />
        </div>

        <div className="w-full h-full z-20 flex flex-col items-center xl:items-start lg:items-start md:items-start sm:items-center justify-center md:order-1 sm:order-2 xl:ml-48 md:ml-36 sm:ml-12 lg:ml-56 px-4 sm:p-8">

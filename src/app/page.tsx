...
export default function Home() {
  return (
    <section className="w-full min-h-screen text-white bg-[#090910] overflow-x-hidden relative">
      ...
      <div className="absolute w-full h-[85vh] md:top-0 md:left-0 md:w-2/5 md:h-full md:ml-24 z-0 flex flex-col items-center md:items-start justify-end md:justify-center px-4">
        <div className="text-center md:text-left">
          <h1 className="text-4xl sm:text-4xl md:text-4xl mt-16 sm:mt-0 lg:text-5xl font-semibold leading-tight font-outfit">
            Descubre los secretos del universo con la física
          </h1>
          <p className="mt-4 text-lg sm:text-lg lg:text-xl tracking-wide font-poppins">
      ...
      <div className="w-full h-[60vh] top-20 md:h-screen md:ml-56 z-20 flex items-center pointer-events-none">
        <CanvasModel />
      </div>
    </section>
  );

      ...
      center items-center flex-col gap-10 w-4/5 h-4/5"
        >
          <p className="text-justify">
            ...
            es parte de la Escuela de Ingeniería de esta Institución, y cumple funciones
            de docencia, investigación y proyección social en el campo de las ciencias
            naturales, las matemáticas, la química y la biología. Este departamento tiene
            como función sustantiva la preparación integral de los futuros ingenieros,
            economistas y administradores de empresa que estudian en esta prestigiosa
            institución. Esto hace que el Departamento de Ciencias Básicas de UNIMETA, sea
            la columna vertebral de la formación de profesionales integrales, capaces de
            abarcar los problemas sociales, culturales y económicos de la región de la
            Orinoquia colombiana, desde una perspectiva cuantitativa, cualitativa y de
            cuidado del medio ambiente, de tal manera que los egresados de nuestra
            Institución Universitaria sean capaces de enfrentar los retos que la
            modernidad impone.
          </p>
          <div className="w-full flex flex-row justify-center items-stretch">
            <div className="w-2/4 h-[65%]">
              <Image
            ...
            <div className="flex flex-col justify-start items-center w-2/4 gap-10 px-12">
              <div>
                ...
                <p className="text-justify">
                  Coadyuvar al desarrollo de planes, programas y proyectos de formación,
                  investigación, extensión, proyección social e internacionalización en el
                  campo de las ciencias básicas con criterios de pertinencia, calidad y
                  excelencia con el fin de promover el avance científico y tecnológico de
              ...
              <div>
                ...
                <p className="text-justify">
                  El departamento será líder en formación e investigación en el campo de
                  Ciencias Básicas en la UNIMETA, promoviendo el interés y el acceso a las
                  mismas, como base del desarrollo tecnológico y científico de nuestra
      ...
      <section className="w-full h-full bg-[#f8f8f8] flex flex-col items-center justify-center relative gap-5">
        <section className="flex justify-center flex-col items-center w-4/5 gap-4">
          ...
          <p className="text-lg text-center">
            ...
            “semillero” con su dedicación y experiencia, generando resultados increíbles
          </p>
        </section>
        <Carousel
          opts={{
